                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="{{route('frontoffice.user.profile')}}" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Perfil
                            </a> 
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        ...
                        <a href="{{route('welcome')}}"> <img alt="image" src="{!!asset('otika/assets/img/logo.png')!!}"
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="{{route('backoffice.admin.show')}}" class="nav-link"><i
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{route('backoffice.users.index')}}">Listado</a></li>
                                <li><a class="nav-link" href="{{route('backoffice.users.create')}}">Registrar</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="layout"></i><span>Roles del sistema</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{route('backoffice.roles.index')}}">Listado</a></li>
                                <li><a class="nav-link" href="{{route('backoffice.roles.create')}}">Registrar</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="layout"></i><span>Permisos del sistema</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{route('backoffice.permissions.index')}}">Listado</a>
                                </li>
                                <li><a class="nav-link" href="{{route('backoffice.permissions.create')}}">Registrar</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{route('backoffice.speciality.index')}}">Listar</a></li>
                                <li><a class="nav-link" href="advance-table.html">Crear</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="{{route('backoffice.doctor.appointments.show', user()->id)}}" class=" nav-link ">
                        ...
                        @else
                        <li class="dropdown">
                            <a href="{{route('backoffice.patient.appointments.show')}}" class=" nav-link ">
                                <i data-feather="clock"></i>
                                    <span>Citas del sistema</span>
                            </a>
                        </li>  
                        @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('backoffice.admin.show')}}">Panel
