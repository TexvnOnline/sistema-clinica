...
@section('styles')
    {!! Html::style('otika/assets/bundles/prism/prism.css') !!}
...
<a class="dropdown-item has-icon" href=""><i class="fas fa-user-plus"></i> Añadir factura </a>
@endsection
@section('breadcrumb')
...
{!! Html::script('otika/assets/bundles/prism/prism.js') !!}
